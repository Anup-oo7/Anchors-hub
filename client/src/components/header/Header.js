  ...
  return (
    ...
    <Component className="navComp">
      <Container>
          ...
          <h3 style={{wordSpacing:5, textDecoration:'underline',margin:'auto'}}>Welcome to Anchors-Hub {account.name}</h3>
        ...
        <MobileMenu anchor="left" open={menuOpen} onClose={toggleMenu}>
          <List>
            ...
            <ListItem component={Link} to={`/jobs/${_id}`}  onClick={toggleMenu}>
              <ListItemIcon>
                < WorkIcon />
              </ListItemIcon>
              <ListItemText primary="Jobs" />
            </ListItem>
            <ListItem component={Link} to={`/profile/${_id}`}   onClick={toggleMenu}>
              <ListItemIcon>
                < PersonIcon />
              </ListItemIcon>
